...
class TestForm(FlaskForm):
    ...
    arch = SelectField('Model:', choices=[('','--select--'),('Bagging','Bagging (Recommended)'), ('DistilBERT','DistilBERT'),('LightGBM','LightGBM'),('RandomForestClassifier','Random Forest'),('XgBoost', 'XgBoost')])
...
class TrainForm(FlaskForm):
    ...
    arch = SelectField('Model:', choices=[('Bagging','--select--'),('Bagging', 'Bagging (Recommended)'),('DistilBERT','DistilBERT'),('LightGBM','LightGBM'),('RandomForestClassifier','Random Forest'),('XgBoost', 'XgBoost')])
