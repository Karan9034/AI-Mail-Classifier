...
class TestForm(FlaskForm):
    ...
    arch = SelectField('Model:', choices=[('','--select--'),('DistilBERT','DistilBERT (Recommended)'), ('Bagging','Bagging'),('LightGBM','LightGBM'),('RandomForestClassifier','Random Forest'),('XgBoost', 'XgBoost')])
...
class TrainForm(FlaskForm):
    ...
    arch = SelectField('Model:', choices=[('Bagging','--select--'),('DistilBERT', 'DistilBERT (Recommended)'),('Bagging','Bagging'),('LightGBM','LightGBM'),('RandomForestClassifier','Random Forest'),('XgBoost', 'XgBoost')])
